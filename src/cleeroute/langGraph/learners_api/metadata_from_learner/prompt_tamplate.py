SUMMARY_PROMPT = [
    ...
    **Task:** Extract title, domains, categories.
    """),
    ("human", """
...
DETAILS_PROMPT = [
	("system", """
		...
		5. Do NOT translate enum values.
		6. No extra text outside the JSON object.

		---

		**Your Role:**  
		You are an expert instructional designer specialized in outcome-based learning.
		...
		**Pedagogical Style:**
		- Write objectives using **first-person plural** ("nous allons", "vous apprendrez").
		- Be concrete, measurable, and learner-oriented.

		---
	"""),
	("human", """
		Elaborate detailed learning goals and requirements using the information below.

		Main Request:
		{prompt}

		Existing Summary (for consistency):
		{context}

		Return ONLY a JSON object matching the `Course_details` schema.
		Ensure `desired_level` is one of: Beginner, Intermediate, Advanced.
""")
]
