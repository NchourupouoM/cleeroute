...
from src.cleeroute.langGraph.course_agents import course_sections_router, course_subsections_router
...
# video_search_router = APIRouter()

# model = get_sentence_transformer_model(MODEL_CONFIG)

# @video_search_router.post("/search", response_model=PaginatedVideoResponse)
...
app.include_router(course_sections_router, prefix="", tags=["Course section Generator"])
app.include_router(course_subsections_router, prefix="", tags=["Course subsection Generator"])
app.include_router(course_structure_router_stream, prefix="", tags=["Course structure streaming Generator"])
app.include_router(project_content_router, prefix="", tags=["Project content Generator"])
app.include_router(project_content_router_stream, prefix="", tags=["Project Content Streaming  Generator"])
